...
4. Click **_OK_** then **_PREVIEW_**.  You will see a bounding box showing the size of the memory produced by the memory compiler. Record the dimension in your logbook.
5. In the Configuration window, click **_AutoName Memory_** button.
6. Select the **_Models_** option at the top and click **_Select ALL_** to generate the full set of models.
7. Finally, click **_Run_** to run the compiler.

Examine the directory for this lab and the files automatically generated by the memory compiler.  

> Examine the Verilog netlist file for the memory block. In particularly, record in your logbook the names of the input/output ports and their purposes. 

**_Step 3 - Examine the layout of the memory block_**

>The following procedure imports the GDS II layout into Virtuoso layout editor. With this procedure, you can examine the layout produced by the Memmory Compiler, or the standard cell layout produced by Innovus PnR tools.
...
* Fill in the required entry of the dialogue box with:
  ...
  8. Open the Layout view. You will see a blue rectangle.
  9. Hide VIA1 VIA2 VIA3 layers to reveal the circuit layout.

<p align="center"> <img src="diagrams/xstream.jpg" width="1000" height="500"> </p><BR>
...
<p align="center"> <img src="diagrams/cct_1.jpg" width="1000" height="180"> </p><BR>
...
Design these three modules in SystemVerilog.

**_Step 2: Integrate SRAM with random logic_**

* Create a top-level design to combine these four blocks to implement the circuit shown.
* Modify the **_synth.tcl_** file from Lab 1 to synthesize the combined circuit using **_Genus_**.
* Modify the **_PnR_** file from Lab 1 to place and route everything with **_Innovus_**.
...
<p align="center"> <img src="diagrams/cct_2.jpg" width="1200" height="160"> </p><BR>
...
<p align="center"> <img src="diagrams/signature_16.jpg" width="1200" height="200"> </p><BR>
